...
<body>
	...
	<table class="table table_striped" >
		...
		<%-- ${movies} viittaa keyword-arvolla request-olion Map-tietorakenteessa olevaan asiakaslistaan(ArrayList) --%>
 
		<c:forEach items="${movies}" var="movies">
			
			<tr>
				<td><c:out value="${movies.id}" /></td>  <%-- lyhennysmerkintä metodikutsulle ${movie.getId()} --%>
				...
				<td><a href="/poista-elokuva?id=<c:out value='${movies.id}'/>">Poista</a></td>
				<td><a href="/muokkaa-elokuvaa?id=<c:out value='${movies.id}'/>">Muokkaa</a></td>
