...
<html>
  ...
  <body>
    ...
    <form action="/muokkaa-elokuvaa" method="post">
      ...
      <p>
        <label>Nimi:</label>
        <input type="text" value="${movie.name}" name="name" size="50" />
      </p>
      <p>
        <label>Ohjaaja:</label>
        <input
      ...
      <p>
        <label>Genre</label>
        <input type="text" value="${movie.genre}" name="genre" size="50" />
      </p>
      <p>
