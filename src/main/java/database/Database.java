...
/**
 * 
 * Luokka toteuttaa tietokantayhteyden muodostavan getDBConnection-metodin ja
 * erilaisia tietokantayhteyden sulkevia closeDBConnection-metodeja
 *
 */
public class Database {
	...
	public static Connection getDBConnection() {
		...
		try {
			// Ladataan ajuri
			Class.forName("com.mysql.cj.jdbc.Driver"); // MySQL tietokanta ajuri
